...
return new class extends Migration
{
     ...
     * directamente a la tabla de visitas y permitir que el cliente_id sea opcional.
     */
    public function up(): void
    {
        Schema::table('visitas', function (Blueprint $table) {
            // CRÍTICO: Cambiamos cliente_id a nullable para evitar el error 1364
            // Esto permite registrar visitas de prospectos que aún no son clientes oficiales.
            $table->unsignedBigInteger('cliente_id')->nullable()->change();

            // Añadimos los campos de identidad del plantel solo si no existen
    ...
    {
        Schema::table('visitas', function (Blueprint $table) {
            // Regresamos el campo a obligatorio
